          ...
          <View style={styles.toggleRow}>
            ...
            <Switch
              ...
              onValueChange={(v) => {
                ...
                void updateHarnessSettings({ showDebugInfo: v });
              }}
        ...
        <View style={styles.settingsCard}>
          ...
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              onValueChange={(val) => {
                if (!developerModeEnabled) return;
                void updateHarnessSettings({ enableAudioPassthrough: val });
              }}
              disabled={!developerModeEnabled}
              trackColor={{ false: 'rgba(255,255,255,0.2)', true: '#00ff88' }}
          ...
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              onValueChange={(val) => {
                if (!developerModeEnabled) return;
                void updateHarnessSettings({ testPatternOnNoVideo: val });
              }}
              disabled={!developerModeEnabled}
              trackColor={{ false: 'rgba(255,255,255,0.2)', true: '#00ff88' }}
